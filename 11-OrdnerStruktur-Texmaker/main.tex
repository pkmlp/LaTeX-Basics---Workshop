...
\usepackage[numbers]{natbib}              % für Literatur-Verzeichnis
\bibliographystyle{unsrtnat}              % für Literatur-Verzeichnis
\renewcommand*{\bibfont}{\raggedright}    % Linksbündinges Literaturverzeichnis
